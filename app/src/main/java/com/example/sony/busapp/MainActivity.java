...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listSliding.add(new ItemSlideMenu(R.drawable.ic_searchcompany, "Tìm Theo Tuyến Online"));
        listSliding.add(new ItemSlideMenu(R.drawable.ic_searchcompany, "Tìm Theo Tuyến Offline"));
        listSliding.add(new ItemSlideMenu(R.drawable.ic_bookmark, "Tìm Theo Đường Đi"));
    ...
    private void replaceFragment(int pos) {
        ...
        switch (pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                Intent intent = new Intent(MainActivity.this, TimTheoDuongDi.class);
